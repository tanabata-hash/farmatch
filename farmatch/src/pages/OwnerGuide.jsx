...
const BENEFITS = [
  ...
  { icon:"📨", title:"手間をかけずに募集できる", desc:"登録は数分で完了。メッセージが届いたらメールでお知らせするので、四六時中サイトを確認する必要はありません。" },
  ...
  return (
    <div style={{ background:C.cream, minHeight:"100vh", fontFamily:"'Hiragino Kaku Gothic ProN','Noto Sans JP',sans-serif" }}>
      ...
      >
        ...
        <H2 icon="📝">登録の流れ</H2>
        <P>
          Farmatchでの掲載はとてもシンプルです。会員登録後、農地の基本情報（所在地・広さ・状況など）を入力するだけで、数分で掲載が完了します。掲載後は、就農希望者からのメッセージをサイト内で受け取り、直接やり取りしながら条件を相談できます。やり取りの内容はお二人だけが閲覧でき、Farmatchは交渉や契約には関与しません（契約手続き自体は当事者間・地元の農業委員会を通じて進めていただきます）。
        </P>
